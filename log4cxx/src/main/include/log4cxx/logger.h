...
namespace log4cxx
{
    ...
    */
    ...
    public:
        ...
        */
        static  LoggerPtr __cdecl getLogger(const std::string& name);
        /**
        * Retrieve a logger by name in current encoding.
        * @param name logger name. 
        */
        static LoggerPtr __cdecl getLogger(const char* const name);
#if LOG4CXX_WCHAR_T_API
        /**
        * Retrieve a logger by name.
        * @param name logger name. 
        */
        static LoggerPtr __cdecl getLogger(const std::wstring& name);
        /**
        * Retrieve a logger by name.
        * @param name logger name. 
        */
        static LoggerPtr __cdecl getLogger(const wchar_t* const name);
#endif
#if LOG4CXX_UNICHAR_API
        /**
        * Retrieve a logger by name.
        ...
        * @param name logger name. 
        */
        static LoggerPtr __cdecl getLoggerLS(const LogString& name);

        /**
        Retrieve the root logger.
        */
        static LoggerPtr __cdecl getRootLogger();
